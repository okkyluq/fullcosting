    ...
    <section class="content">
        <div class="row">
    		<div class="col-sm-8 col-sm-offset-2">
    			...
    			<div class="box-body">
    				<form class="form-horizontal" method="POST" action="{{url('bop')}}" enctype="multipart/form-data">
                        <div class="form-group {{ $errors->has('kode_bop') ? ' has-error' : '' }}">
    	      				<label class="control-label col-sm-3" for="kode_bop">Kode BOP :</label>
    		      			<div class="col-sm-6">
    		        			<input type="text" class="form-control" id="kode_bop" name="kode_bop" readonly value="{{ $kode }}">
