        ...
        <div class="row">
    		<div class="col-sm-8 col-sm-offset-2">
    			...
    			<div class="box-header">
    				...
    				<h3 class="box-title">Input Data Biaya Tenaga Kerja Langsung</h3>
    			</div>
    			<div class="box-body">
    				<form class="form-horizontal" method="POST" action="{{url('btkl')}}" enctype="multipart/form-data">
                        <div class="form-group {{ $errors->has('kode_btkl') ? ' has-error' : '' }}">
    	      				<label class="control-label col-sm-3" for="kode_btkl">Kode BTKL :</label>
    		      			<div class="col-sm-6">
    		        			<input type="text" class="form-control" id="kode_btkl" name="kode_btkl" readonly value="{{ $kode }}">
                        ...
                        <div class="form-group {{ $errors->has('btkl') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="btkl" name="btkl">
                                @if ($errors->has('btkl'))
                                    <span class="help-block">
