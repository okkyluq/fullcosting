...
<section class="content">
    <div class="row">
		<div class="col-md-6 text-left" style="margin-bottom: 20px;">
            <a href="{{url('btkl/create')}}" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambah Data</a>
		</div>
	</div>
		...
		<div class="col-sm-12">
			<div class="box box-danger">
				<div class="box-header">
					...
					<h3 class="box-title">Data Biaya Tenaga Kerja Langsung</h3>
				</div>
				<div class="box-body">
					@if (!empty($btkl))
						<table class="table">
								...
								<tr>
									...
									<td class="text-center">
										<div class="box-button" style="display: inline-block;">
											<a href="{{url('btkl/'.$isi->id.'/edit')}}" class="btn btn-xs btn-success"><i class="fa fa-edit"></i></a>
										</div>
										<div class="box-button" style="display: inline-block;">
											<form action="{{url('btkl/'.$isi->id)}}" method="POST">
