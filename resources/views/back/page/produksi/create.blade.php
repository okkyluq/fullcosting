        ...
        <div class="row">
    		<div class="col-sm-8 col-sm-offset-2">
    			...
    			<div class="box-header">
    				...
    				<h3 class="box-title">Input Data Produksi</h3>
    			</div>
    			<div class="box-body">
    				<form class="form-horizontal" method="POST" action="{{url('produksi')}}" enctype="multipart/form-data">
                        <div class="form-group {{ $errors->has('kode_produksi') ? ' has-error' : '' }}">
    	      				<label class="control-label col-sm-3" for="kode_produksi">Kode BOP :</label>
    		      			<div class="col-sm-6">
    		        			<input type="text" class="form-control" id="kode_produksi" name="kode_produksi" readonly value="{{ $kode }}">
                        ...
                        <div class="form-group {{ $errors->has('nama_produksi') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="nama_produksi" name="nama_produksi">
