...
<section class="content">
    <div class="row">
		<div class="col-md-6 text-left" style="margin-bottom: 20px;">
            <a href="{{url('transaksi-bahan/create')}}" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambah Data</a>
		</div>
	</div>
		...
		<div class="col-sm-12">
			<div class="box box-danger">
				<div class="box-header">
					...
					<h3 class="box-title">Data Transaksi Bahan Baku</h3>
				</div>
				<div class="box-body">
					@if (!empty($t_bahan))
						<table class="table">
							<thead>
								<tr>
									...
									<td><strong>Kode Transaksi Bahan Baku</strong></td>
							...
							<tbody>
								@php $no=1 @endphp
								@foreach ($t_bahan as $isi)
								<tr>
									<td>{{$no++}}</td>
									<td class="text-left">{{$isi->kode_transaksi_bahan}}</td>
									...
									<td class="text-center">
										<div class="box-button" style="display: inline-block;">
											<a href="{{ url('transaksi-bahan/'.$isi->id) }}" class="btn btn-xs btn-primary"><i class="fa fa-eye"></i></a>
										</div>
									</td>
									<td class="text-center">{{date_format($isi->created_at, 'Y-m-d')}}</td>
									<td class="text-center">
										<div class="box-button" style="display: inline-block;">
											<form action="{{url('transaksi-bahan/'.$isi->id)}}" method="POST">
